...
Our [main course website](https://thomaselove.github.io/431-2022/) will provide details on all of these deliverables to you. This syllabus material describes each in general terms, and provides some guidance on what happens after the deadline for each.
...
3.  Email Professor Love if you want to discuss something that doesn't fit on Campuswire or in a conversation with a TA. Visit with him before or after class. Make an appointment to talk with him if you have something to discuss that doesn't work well in email. 
  - It's always helpful if Professor Love knows who you are, and this is an especially difficult thing to achieve this year with a large class and masks.
...
More information (and the actual Lab assignments) will be found on [our main course web site](https://thomaselove.github.io/431-2022/).
...
During the semester, you will have three quizzes to complete. See the [Course Calendar](https://thomaselove.github.io/431-2022/calendar.html) for deadlines, and the [Course Quiz page](https://github.com/THOMASELOVE/431-2022/tree/main/quizzes) for other details.
...
For more information on the Quizzes, please visit [our main course web site](https://thomaselove.github.io/431-2022/).
...
For more information on the Projects, please visit the Assignments section of  [our main course web site](https://thomaselove.github.io/431-2022/).
