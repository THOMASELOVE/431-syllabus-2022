...
1. This syllabus includes **fourteen** sections. Use the table of contents on the left side of the screen to navigate. Make sure you look at each section.
...
We'll learn about managing and visualizing data, building models and making predictions, and other data science activities. This highly applied course focuses on modern tools for learning from data. We'll learn a lot of R, and we'll use RStudio and R Markdown (and, in 432, Quattro) as tools to help make R work better, and help perform our research in rigorous and replicable ways.
...
Once class begins, you'll be able to access all materials (including the Course Notes) through the main course website at https://thomaselove.github.io/431-2022/.
...
These instructions are also available on [the Software page](https://thomaselove.github.io/431-2022/software.html) at our main course website: https://thomaselove.github.io/431-2022/.
...
2. Download and install **RStudio Desktop** (Open Source Edition - the free version **2022.07.1+554 or later**) at https://www.rstudio.com/products/rstudio/download/#download. 
...
- I am a Fellow of the American Statistical Association, and was recently elected 2024 Chair for its Council of Sections Governing Board.
...
- We will use [Campuswire](https://thomaselove.github.io/431-2022/campuswire.html) this semester to facilitate questions and answers. We'll be conducting all class-related discussion there, instead of via email.
- You can sign up for this class on Campuswire at https://campuswire.com/p/G773930B7. 
...
- More [information on the TAs is available here][Teaching Assistants].
...
Professor Love does not hold regular office hours. He will arrive 10 minutes before each class, and stay afterwards, as well, to address any drop-in student concerns that can be addressed in that setting.
...
- Remember that most questions about course materials are best asked through [Campuswire](https://thomaselove.github.io/431-2022/campuswire.html) or at TA Office Hours so that we can share the answers across all students in the course.
...
The Assignments page linked on the [main course website](https://thomaselove.github.io/431-2022/) provides links to additional information on these assignments.

## Deadlines for Assignments

All deadlines are posted as part of the [Course Calendar](https://thomaselove.github.io/431-2022/calendar.html), and the Calendar is the final word for all deadlines.
...
The [Course Calendar](https://thomaselove.github.io/431-2022/calendar.html) provides deadlines for all Labs, and the Assignments page linked on the [main course website](https://thomaselove.github.io/431-2022/) provides additional information on all Labs.
...
There will be an additional assignment called Lab X which involves building a website for yourself. When it becomes available, see the Lab X instructions for more details.
...
The [Course Calendar](https://thomaselove.github.io/431-2022/calendar.html) provides deadlines for each of the Quizzes, and the [Assignments page on the main course website](https://thomaselove.github.io/431-2022/assignments.html) provides links to instructions for Quizzes.
...
- Project A anticipates you using materials from the first 15 classes.
- Project B anticipates you using materials from all 24 classes.

The [Course Calendar](https://thomaselove.github.io/431-2022/calendar.html) provides deadlines for all Project elements, and the [Assignments page on the main course website](https://thomaselove.github.io/431-2022/assignments.html) provides additional information on all Projects.
...
- 30 points for completing the [Welcome to 431  survey](https://bit.ly/431-2022-welcome-survey) that most of you did prior to class, and if you haven't done it, please do so now.
...
All Labs should be turned in by the deadline specified on the [Course Calendar](https://thomaselove.github.io/431-2022/calendar.html). In this class, it is far better to turn in timely, but only partially complete work than nothing at all. We don't give extensions on Labs. Instead, we use the following grading policy.
...
- On [the course's Labs page](https://github.com/THOMASELOVE/431-labs-2022), we include a section about Lab Regrade Requests. There, you'll find a link to [this Google Form](https://bit.ly/431-2022-lab-regrade-requests) (you must log into Google via CWRU to see it) listing all of the Labs. Any student who wishes to dispute points can specify the number of points in question for each item, and the details of the issues that concern them. 
...
Once you have read through this Syllabus, please e-mail Professor Love the poster for one of your favorite movies. Use the subject line: **431 Favorite Movie**. If he receives your poster by 9 AM Eastern time on Tuesday 2022-09-06, he will add some bonus credit to your class participation grade.
